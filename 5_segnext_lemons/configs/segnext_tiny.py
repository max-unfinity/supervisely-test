_base_ = [
    ...
    '../../_base_/datasets/lemons_light_aug.py',
...
model = dict(
    init_cfg=dict(type='Pretrained', checkpoint='/kaggle/input/segnext-tiny-pretrained-ade/segnext_tiny_512x512_ade_160k.pth'),
    type='EncoderDecoder',
#     backbone=dict(
